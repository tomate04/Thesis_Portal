...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 23. Nov 2022 um 11:51
...
INSERT INTO `anfragen` (`AnfrageID`, `Betreuer`, `Student`, `Thema`) VALUES
(1, 'John', 'Doe', 'john@example.com'),
(12, 'Professor', 'Professor', 'Professor'),
(13, 'test', 'test', 'test'),
(14, 'Bloch', 'Felix', 'sdfasdfasfd'),
(15, 'Bloch', 'Max', 'sdfaasfd');
...
--
ALTER TABLE `anfragen`
  MODIFY `AnfrageID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
